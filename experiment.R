...
cull_df <- rio::import("Output\\control_data\\cull_20240416_124100.csv")
manta_tow_df <- rio::import("Output\\control_data\\manta_tow_20240416_123437.csv") 
...
write.csv(manta_output, "Output\\control_data\\manta_tow_20240416_123437v2.csv", row.names = FALSE)
write.csv(cull_df, "Output\\control_data\\cull_20240416_124100v2c.csv", row.names = FALSE)
